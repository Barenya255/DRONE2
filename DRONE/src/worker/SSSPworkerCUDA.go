...
func (w *SSSPWorkerCUDA) ShutDown(ctx context.Context, args *pb.EmptyRequest) (*pb.ShutDownResponse, error) {
...
func (w *SSSPWorkerCUDA) peval(args *pb.EmptyRequest) {
	res := tools.CUDA_SSSP_PEVal(w.g, w.values, 0, tools.CInt(w.selfId-1), tools.CInt(w.workerNum), w.comm)
...
func (w *SSSPWorkerCUDA) PEval(ctx context.Context, args *pb.EmptyRequest) (*pb.PEvalResponse, error) {
	go w.peval(args)
	return &pb.PEvalResponse{Ok: true}, nil
}

func (w *SSSPWorkerCUDA) incEval(args *pb.EmptyRequest) {
	res := tools.CUDA_SSSP_IncEVal(w.g, w.values, tools.CInt(w.selfId-1), tools.CInt(w.workerNum), w.comm)
...
func (w *SSSPWorkerCUDA) IncEval(ctx context.Context, args *pb.EmptyRequest) (*pb.IncEvalResponse, error) {
	go w.incEval(args)
	return &pb.IncEvalResponse{Update: true}, nil
}

func (w *SSSPWorkerCUDA) Assemble(ctx context.Context, args *pb.EmptyRequest) (*pb.AssembleResponse, error) {
	return &pb.AssembleResponse{Ok: true}, nil
}

func (w *SSSPWorkerCUDA) ExchangeMessage(ctx context.Context, args *pb.EmptyRequest) (*pb.ExchangeResponse, error) {
	return &pb.ExchangeResponse{Ok: true}, nil
}

func (w *SSSPWorkerCUDA) MessageSend(ctx context.Context, args *pb.MessageRequest) (*pb.EmptyResponse, error) {
	return &pb.EmptyResponse{}, nil
}

func (w *SSSPWorkerCUDA) SyncVal(ctx context.Context, args *pb.SyncRequest) (*pb.EmptyResponse, error) {
	return &pb.EmptyResponse{}, nil
}

func (w *SSSPWorkerCUDA) BeatHeart(ctx context.Context, args *pb.EmptyRequest) (*pb.EmptyResponse, error) {
	return &pb.EmptyResponse{}, nil
}

func (w *SSSPWorkerCUDA) Recovery(ctx context.Context, args *pb.RecoveryRequest) (*pb.EmptyResponse, error) {
	return &pb.EmptyResponse{}, nil
}
...
func newSSSPWorkerCUDA(id, partitionNum int) *SSSPWorkerCUDA {
	w := new(SSSPWorkerCUDA)
	w.selfId = id
	...
	//w.values = new(tools.CUDA_SSSPValues)
	//w.comm = new(tools.CComm)
...
func RunSSSPWorkerCUDA(id, partitionNum int) {
	w := newSSSPWorkerCUDA(id, partitionNum)
